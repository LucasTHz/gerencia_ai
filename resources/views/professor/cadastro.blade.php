...
<form class="row g-3" method="POST" action="{{route('professor.store')}}">
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="form-control @error('matricula') is-invalid @enderror" name="matricula" placeholder="Sua matricula"
            id="inputMatricula">
        @error('matricula')
        <div class="invalid-feedback">
            {{$message}}
    ...
    <div class="col-md-4">
            ...
            <input type="text" class="form-control @error('endereco_curriculo') is-invalid @enderror" name="endereco_curriculo" placeholder="Seu Curriculo"
                id="inputCurriculo">
